"""
Django settings for moduleRegistration project.
...
ROOT_URLCONF = 'moduleRegistration.urls'
...
WSGI_APPLICATION = 'moduleRegistration.wsgi.application'
...
DEFAULT_FILE_STORAGE = 'moduleRegistration.storages.AzureMediaStorage'
STATICFILES_STORAGE = 'moduleRegistration.storages.AzureStaticStorage'
STATIC_URL = 'c1003593dcbs.blob.core.windows.net/static/'
MEDIA_URL = 'c1003593dcbs.blob.core.windows.net/media/'
